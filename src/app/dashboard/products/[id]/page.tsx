      ...
      <div className="p-6 max-w-5xl mx-auto rounded-lg ">
        ...
        <div className="flex  items-center justify-between pr-6">
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={() => {
                router.push(
                  `/dashboard/products/1?type=${type}&&page=analytics`
                );
              }}
        ...
        <div className="flex flex-row">
          <div className="flex flex-col gap-2 mt-4 w-1/4">
            ...
            <div>
              <h4 className="font-bold text-base text-kikaeBlue">
                Description
              </h4>
              <p className="text-base text-kikaeGrey">
                This shirt isn&apos;t just comfortable, it&apos;s practically
                ethereal. The &quot;Cloudchaser&quot; is crafted from 100%
                organic linen, a fabric so lightweigh... View more
              </p>
            </div>
          </div>
          {/* Product Details */}
